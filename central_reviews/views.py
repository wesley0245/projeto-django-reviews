...
from django.db.models import Q # Para o Filtro
...
class CadastroView(SuccessMessageMixin, CreateView): 
    ...
    # A mensagem que será mostrada após o cadastro 
    success_message = "Sua conta foi criada com sucesso! Faça o login."


    def get_form(self, form_class=None):
        """
        Sobrescreve este método para modificar o formulário 
        antes que ele seja enviado para o template.
        """
        # Pega o formulário como ele seria normalmente
        form = super().get_form(form_class)
        
        # Acessa o campo 'username' e apaga o texto de ajuda
...
class TenisDetailView(DetailView):
    ...
    """
    model = Tenis # Buscar UM objeto do modelo Tenis
